window.REALNEWS_STORIES = [
  {
    ...
    summary: "Demo summary: Western governments are discussing longer-term support and security assurances for Ukraine, with debate over scope, cost, and deterrence.",
    confidence: 78,
    trend: 96,
  ...
  },
  {
    ...
    summary: "Demo summary: Central banks are signalling caution on interest-rate cuts as inflation cools in some areas while wage and services prices remain watched.",
    confidence: 77,
    trend: 90,
  ...
  },
  {
    ...
    summary: "Demo summary: Lawmakers, companies, and civil-society groups are debating how to regulate high-risk AI systems without blocking useful deployment.",
    confidence: 69,
    trend: 87,
  ...
  },
  {
    ...
    summary: "Demo summary: Local governments are asking for clearer adaptation funding as extreme-weather costs put pressure on infrastructure budgets.",
    confidence: 73,
    trend: 82,
  ...
  },
  {
    ...
    summary: "Demo summary: A migration enforcement proposal is drawing debate over border capacity, legal safeguards, costs, and practical delivery.",
    confidence: 66,
    trend: 78,
